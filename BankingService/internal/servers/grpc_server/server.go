...
type Server struct {
	protobuf.UnimplementedBankingServiceServer
	srv     *grpc.Server
...
func NewGrpcServer(logger *logrus.Logger, cfg *config.Config, service service.BankingService) *Server {
	grpc.NewServer()
	return &Server{
...
func (s *Server) Start() error {
	...
	protobuf.RegisterBankingServiceServer(grpcServer, s)
